 ...
 */
final class Version20260102234132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis_client (id INT AUTO_INCREMENT NOT NULL, note INT NOT NULL, commentaire LONGTEXT NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, INDEX IDX_708E90EFA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, date_commande DATETIME NOT NULL, status VARCHAR(255) NOT NULL, montant_total DOUBLE PRECISION NOT NULL, user_id INT NOT NULL, INDEX IDX_6EEAA67DA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, methode VARCHAR(255) NOT NULL, montant DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, date_paiement DATETIME NOT NULL, user_id INT NOT NULL, INDEX IDX_B1DC7A1EA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, stock INT NOT NULL, reference VARCHAR(255) NOT NULL, category_id INT NOT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, message LONGTEXT NOT NULL, date DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, sujet VARCHAR(255) NOT NULL, reponse LONGTEXT DEFAULT NULL, user_id INT NOT NULL, commande_id INT DEFAULT NULL, product_id INT DEFAULT NULL, INDEX IDX_CE606404A76ED395 (user_id), INDEX IDX_CE60640482EA2E54 (commande_id), INDEX IDX_CE6064044584665A (product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
